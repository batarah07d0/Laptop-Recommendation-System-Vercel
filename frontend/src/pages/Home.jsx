    ...
    <div className="max-w-4xl mx-auto py-6 md:py-10 px-4">
      ...
      <div className="bg-white p-5 md:p-8 rounded-xl shadow-lg border border-gray-100">
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-3 bg-blue-50 p-5 md:p-6 rounded-lg border border-blue-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
            <div className="relative">
              ...
              <select
                ...
                className="w-full p-2.5 text-sm md:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white outline-none"
              >
                <option value="All">Semua Prosesor</option>
                <optgroup label="Intel">
                  <option value="Intel Core i3">Intel Core i3 (Ringan)</option>
                  <option value="Intel Core i5">
                    Intel Core i5 (Menengah)
                  </option>
                  <option value="Intel Core i7">Intel Core i7 (Tinggi)</option>
                ...
                <optgroup label="AMD">
                  <option value="AMD Ryzen 3">AMD Ryzen 3 (Ringan)</option>
                  <option value="AMD Ryzen 5">AMD Ryzen 5 (Menengah)</option>
                  <option value="AMD Ryzen 7">AMD Ryzen 7 (Tinggi)</option>
                  <option value="AMD Ryzen 9">
                    AMD Ryzen 9 (Sangat Tinggi)
                  </option>
                  <option value="AMD Ryzen AI">AMD Ryzen AI (AI/Modern)</option>
                </optgroup>
          ...
          <div className="mb-4 text-center border-t border-b border-gray-100 py-2 md:py-2">
            <button
              type="button"
              onClick={() => setShowAdvanced(!showAdvanced)}
              className="text-xs md:text-sm font-bold text-gray-500 hover:text-blue-600 transition-colors flex items-center justify-center w-full p-2 rounded-lg hover:bg-gray-50 focus:outline-none"
            >
              <svg
          ...
          {showAdvanced && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6 mb-4 bg-gray-50 p-5 md:p-6 rounded-lg border border-gray-200">
              <div className="relative">
                <label className="flex items-center text-sm font-semibold text-gray-700 mb-2">
                  Sistem Operasi{" "}
                ...
                <select
                  ...
                  className="w-full p-2 text-sm md:text-base border border-gray-300 rounded-lg bg-white outline-none focus:ring-2 focus:ring-blue-500"
                >
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="Integrated">Integrated (Irit Baterai)</option>
                  <option value="Dedicated">Dedicated (Performa Tinggi)</option>
                </select>
              </div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="2.5K">WQXGA (Sangat Tajam & Jernih)</option>
          ...
          {error && (
            <div className="mt-4 bg-red-50 text-red-600 p-4 rounded-lg font-semibold text-center">
              {error}
            </div>
          )}
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`w-full hover:bg-blue-700 text-white font-bold py-3 md:py-4 px-4 rounded-lg shadow-md transition-colors flex justify-center items-center mt-2 text-sm md:text-base ${isLoading ? "bg-blue-600 opacity-75 cursor-not-allowed shadow-none" : "bg-blue-600"}`}
          >
            {isLoading ? (
              <>
                <svg
