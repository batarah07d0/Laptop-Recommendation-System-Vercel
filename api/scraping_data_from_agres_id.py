...
INPUT_FILE = BASE_DIR / "datasets" / "Link_1.txt"
OUTPUT_FILE = BASE_DIR / "datasets" / "laptop_data_agres.xlsx"
FAILED_FILE = BASE_DIR / "datasets" / "failed_urls.txt"
...
def scrape_product(url):
    ...
    # Image URL extraction (List or String)
    # image_data = product_json.get(
    #     "image",
    #     []
    # )
